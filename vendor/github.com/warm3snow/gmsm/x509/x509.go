...
func marshalPublicKey(pub interface{}) (publicKeyBytes []byte, publicKeyAlgorithm pkix.AlgorithmIdentifier, err error) {
	...
	case *sm2.PublicKey:
		...
		publicKeyAlgorithm.Parameters.FullBytes = paramBytes
		publicKeyAlgorithm.Algorithm = oidPublicKeySM2 //oidPublicKeySM2 is from oidPublicKeyECDSA
		//**********2
		/*
		...
		*/
	default:
		return nil, pkix.AlgorithmIdentifier{}, errors.New("x509: only RSA and ECDSA and SM2 public keys supported")
	}
...
var (
	...
	oidSignatureSM2WithSHA256 = asn1.ObjectIdentifier{1, 2, 156, 10197, 1, 503} //sha256WithSM2
	//oidSignatureSM2WithSM3    = asn1.ObjectIdentifier{1, 2, 156, 10197, 1, 501} //SM3WithSM2
...
func getPublicKeyAlgorithmFromOID(oid asn1.ObjectIdentifier) PublicKeyAlgorithm {
	...
	case oid.Equal(oidPublicKeyDSA):
		return DSA
	case oid.Equal(oidPublicKeyECDSA): //sm2 use ecdsa public key asn1-encoding oidPublicKeySM2
		return ECDSA
	}
...
func checkSignature(algo SignatureAlgorithm, signed, signature []byte, publicKey crypto.PublicKey) (err error) {
	...
	case *ecdsa.PublicKey:
		...
		return
	case *sm2.PublicKey:
		sm2Sig := new(ecdsaSignature) //same as dsaSignature
...
func signingParamsForPublicKey(pub interface{}, requestedSigAlgo SignatureAlgorithm) (hashFunc crypto.Hash, sigAlgo pkix.AlgorithmIdentifier, err error) {
	...
	case *sm2.PublicKey:
		...
		default:
			err = errors.New("x509: unknow elliptic curve [Should be P256Sm2]")
		}
	default:
		err = errors.New("x509: only RSA and ECDSA and SM2 keys supported")
	}
